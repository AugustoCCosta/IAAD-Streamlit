-- create database empresa_adaptado_iaad
-- use empresa_adaptado

begin;
drop schema if exists Empresa_adaptado;
create schema Empresa_adaptado; 
use Empresa_adaptado;
...
FOR EACH ROW
BEGIN
    IF NEW.Salario > 55000 THEN
        SIGNAL SQLSTATE '45000'
        SET MESSAGE_TEXT = 'Não é permitido atualizar o salário para mais de 50.000';
    END IF;
END;
//
DELIMITER ;
